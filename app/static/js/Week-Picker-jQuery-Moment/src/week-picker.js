function get_Active(){
	b = document.getElementsByClassName("_active");
...
(function () {
	...
	var getLocale = function (locale) {
		...
		switch (locale) {
			...
			default:
				loc = {
					OPEN_PICKER_SINGLE: "Selectionner une semaine...",
					OPEN_PICKER: "Ouvrir le calendrier...",
					CLEAR: "Effacer",
					NUM_SELECTED: "$num_selected semaines sélectionnées",
					WEEK_SELECTED: "Semaine $weeknum, $year"
				}
		}
		return loc;
	}
